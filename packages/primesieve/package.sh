...
# rm -rf /tmp/primesieve2-$pkgver
#git archive HEAD --prefix=$pkgname-$pkgver/ | bzip2 > /tmp/$pkgname-$pkgver.tar.bz2
#cd /tmp

wget -c https://github.com/kimwalisch/primesieve/archive/refs/tags/v${pkgver}.tar.gz -P /tmp
# tar xzf v${pkgver}.tar.gz
# 
# 
# rm -f "$pkgname"_$debver*
# cp v${pkgver}.tar.gz "$pkgname"_$debver.orig.tar.gz
# cd /tmp/primesieve2-$pkgver
# 
# cp -r ~/projects/openturns/primesieve-pkg/debian .  
# 
